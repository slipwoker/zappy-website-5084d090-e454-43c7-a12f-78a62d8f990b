document.addEventListener('DOMContentLoaded', function () {
  ...
  function handleFormSuccess(form) {
    ...
    successEl.textContent = form.getAttribute('data-success-message') ||
  ...
  const dynamicContentRoots = document.querySelectorAll('[data-dynamic-content]');
  if (dynamicContentRoots.length && 'MutationObserver' in window) {
    const mutationObserver = new MutationObserver(function (mutations) {
      mutations.forEach(function (mutation) {
        mutation.addedNodes.forEach(function (node) {
          if (node.nodeType !== 1) return;

          const newAnimatables = node.matches && node.matches(OBSERVE_SELECTOR)
            ? [node]
            : Array.from(node.querySelectorAll ? node.querySelectorAll(OBSERVE_SELECTOR) : []);
    ...
    dynamicContentRoots.forEach(function (root) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "סקווישי לנד משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '5084d090-e454-43c7-a12f-78a62d8f990b',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '5084d090-e454-43c7-a12f-78a62d8f990b';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '5084d090-e454-43c7-a12f-78a62d8f990b';
